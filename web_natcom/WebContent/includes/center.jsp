<ul id="infoPan">
	<li>
		<h3>
			<span>dise&ntilde;o</span> web <img src="images/icon1.png" alt="" />
		</h3>
		<p>Accesibilidad</p>
		<p class="descrip">El diseño web debe seguir unos requerimientos
			mínimos de accesibilidad web que haga que sus sitios web o
			aplicaciones puedan ser visitados por el mayor número de personas.
			Para conseguir estos objetivos de accesibilidad se han desarrollado
			pautas como las del W3C: Pautas de accesibilidad al contenido Web 1.0
			WCAG.</p>
	</li>
	<li>
		<h3>
